...
import (
	...
	"github.com/ankitpokhrel/jira-cli/internal/cmd/issue/bulkcreate"
...
func NewCmdIssue() *cobra.Command {
	...
	bc := bulkcreate.NewCmdBulkCreate()

	cmd.AddCommand(
		lc, cc, bc, edit.NewCmdEdit(), move.NewCmdMove(), view.NewCmdView(), assign.NewCmdAssign(),
